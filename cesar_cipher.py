"""Student Name: Dolma Phuti Sherpa"""
"""Student ID: NP03CS4A220266"""
def welcome():
...
def enter_message():
    """Asks for encryption/decryption mode, message and shift value, returns them"""
    while True:
...
def decrypt(message, shift):
    """Decrypts a message using a shift value"""
    decrypted_text = ""
    for char in message:
        if char.isalpha():
            shift_char = chr((ord(char) - shift - 65) % 26 + 65)
